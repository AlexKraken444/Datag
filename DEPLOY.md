...
Datag — **fully serverless**. Никаких long-running процессов, никаких WebSocket-серверов. Игра работает peer-to-peer через WebRTC; Vercel хостит только статику + REST для лидерборда/истории.

## Vercel

1. Зайди на vercel.com → **Add New → Project** → импортируй `AlexKraken444/Datag`.
...
- Datag использует публичный TURN-фоллбэк `openrelay.metered.ca` — должен покрывать большинство случаев.
